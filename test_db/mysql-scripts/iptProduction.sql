...
--
-- Host: ipt-production.cxaptbhajuia.us-east-2.rds.amazonaws.com    Database: iptProduction
-- ------------------------------------------------------
...
CREATE TABLE `customers` (
  ...
  `num_media_sent` int(11) NOT NULL,
...
-- Dump completed on 2019-12-01 20:29:19
